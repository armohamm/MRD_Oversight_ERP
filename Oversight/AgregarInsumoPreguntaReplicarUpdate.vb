Public Class AgregarInsumoPreguntaReplicarUpdate
    ...
    Private Sub setControlsByPermissions(ByVal windowname As String, ByVal username As String)
        ...
        If viewPermission = False Then
            ...
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Acceso denegado a la ventana de Replicar Precios', 'OK')")
    ...
    Private Sub AgregarInsumoPreguntaReplicarUpdate_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        If rbBase.Checked = True Then
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Replicar Precios replicando a Base', 'OK')")
        Else
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Replicar Precios replicando a Proyecto/Modelo', 'OK')")
        End If

    End Sub


    Private Sub AgregarInsumoPreguntaReplicarUpdate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub AgregarInsumoPreguntaReplicarUpdate_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la ventana de Replicar Precios', 'OK')")

        If IsModel = True Then

            rbProyecto.Visible = False
            rbProyecto.Select()
