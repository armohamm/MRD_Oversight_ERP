Public Class BuscaTipoActivos
    ...
    Private Sub setControlsByPermissions(ByVal windowname As String, ByVal username As String)
        ...
        If viewPermission = False Then
            ...
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Acceso denegado a la ventana de Buscar Tipos de Activo', 'OK')")
    ...
    Private Sub BuscaTipoActivos_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Buscar Tipos de Activo con el Tipo de Activo " & iassettypeid & " : " & sassettypedescription & " seleccionado', 'OK')")

    End Sub


    Private Sub BuscaTipoActivos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaTipoActivos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT iassettypeid, sassettypedescription AS 'Tipo de Activo' " & _
        "FROM assettypes " & _
        "WHERE sassettypedescription LIKE '%" & querystring & "%' " & _
        "ORDER BY 1 "

        txtBuscar.Enabled = True

        setDataGridView(dgvTipoActivos, queryBusqueda, True)

        dgvTipoActivos.Columns(0).Visible = False

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la Ventana de Buscar Tipos de Activo', 'OK')")

        dgvTipoActivos.Select()
    ...
    Private Sub dgvTipoActivos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoActivos.CellClick

        Try

            If dgvTipoActivos.CurrentRow Is Nothing Then
                Exit Sub
            End If

            iassettypeid = CInt(dgvTipoActivos.Rows(e.RowIndex).Cells(0).Value)
            sassettypedescription = dgvTipoActivos.Rows(e.RowIndex).Cells(1).Value
    ...
    Private Sub dgvTipoActivos_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoActivos.CellContentClick
    ...
    Private Sub dgvTipoActivos_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvTipoActivos.SelectionChanged
        ...
        Try
            ...
            iassettypeid = CInt(dgvTipoActivos.CurrentRow.Cells(0).Value)
            sassettypedescription = dgvTipoActivos.CurrentRow.Cells(1).Value
    ...
    Private Sub dgvTipoActivos_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoActivos.CellContentDoubleClick
        ...
        If dgvTipoActivos.SelectedRows.Count = 1 Then
            ...
            Dim ata As New AgregarTipoActivo

            ata.susername = susername
            ata.bactive = bactive
            ata.bonline = bonline
            ata.suserfullname = suserfullname
            ata.suseremail = suseremail
            ata.susersession = susersession
            ata.susermachinename = susermachinename
            ata.suserip = suserip
            
            ata.iassettypeid = iassettypeid

            ata.isEdit = True

            If Me.WindowState = FormWindowState.Maximized Then
                ata.WindowState = FormWindowState.Maximized
            End If
    ...
    Private Sub dgvTipoActivos_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoActivos.CellDoubleClick
    ...
    Private Sub btnCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrear.Click
        ...
        If ata.DialogResult = Windows.Forms.DialogResult.OK Then

            Me.iassettypeid = ata.iassettypeid
            Me.sassettypedescription = ata.sassettypedescription

            If ata.wasCreated = True Then
                Me.wasCreated = True
            End If
