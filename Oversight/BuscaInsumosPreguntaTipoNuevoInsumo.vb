Public Class BuscaInsumosPreguntaTipoNuevoInsumo
    ...
    Private Sub setControlsByPermissions(ByVal windowname As String, ByVal username As String)
        ...
        If viewPermission = False Then
            ...
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Acceso denegado a la ventana de Escoger Tipo de Insumo Nuevo', 'OK')")
    ...
    Private Sub BuscaInsumosPreguntaTipoNuevoInsumo_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        If iselectedoption = 1 Then
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Escoger Tipo de Insumo Nuevo con el tipo Normal seleccionado', 'OK')")
        ElseIf iselectedoption = 2 Then
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Escoger Tipo de Insumo Nuevo con el tipo Compuesto seleccionado', 'OK')")
        End If

    End Sub


    Private Sub BuscaInsumosPreguntaTipoNuevoInsumo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaInsumosPreguntaTipoNuevoInsumo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la Ventana de Escoger Tipo de Insumo Nuevo', 'OK')")

        If restrictCompounds = True Then
            rbCompuesto.Visible = False
        End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActualizar.Click
        ...
        If rbCompuesto.Checked = True Then
            iselectedoption = 2
        End If
