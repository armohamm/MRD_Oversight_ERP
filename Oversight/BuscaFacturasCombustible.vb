Public Class BuscaFacturasCombustible
    ...
    Private Sub BuscaFacturasCombustible_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BuscaFacturasCombustible_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaFacturasCombustible_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT isupplierinvoiceid AS 'ID Factura', isupplierid AS 'ID Proveedor', ssuppliername AS 'Nombre Comercial', sexpensedescription AS 'Descripcion Factura', " & _
        "fecha AS 'Fecha', montofactura AS 'Monto Factura', srevisionresult AS 'Revisado hasta' " & _
        "FROM ( " & _
        "SELECT si.isupplierinvoiceid, s.isupplierid, s.ssuppliername, si.sexpensedescription, " & _
        "STR_TO_DATE(CONCAT(si.iinvoicedate, ' ', si.sinvoicetime), '%Y%c%d %T') AS fecha, " & _
        "FORMAT(IF(SUM(gv.dgasvoucheramount) IS NULL, 0, SUM(gv.dgasvoucheramount)), 2) AS montofactura, " & _
        ...
        "LEFT JOIN (SELECT re.irevisionid, re.sid, re.irevisionresultid, rer.srevisionresult FROM revisions re JOIN revisionresults rer ON rer.irevisionresultid = re.irevisionresultid WHERE re.srevisiondocument = 'Factura de Combustible' ORDER BY re.irevisionresultid DESC) re ON re.sid = si.isupplierinvoiceid " & _
        "WHERE " & _
    ...
    Private Sub dgvFacturas_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvFacturas.CellContentDoubleClick
        ...
        If dgvFacturas.SelectedRows.Count = 1 Then
            ...
            afc.isupplierinvoiceid = isupplierinvoiceid
            ...
            If afc.DialogResult = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub btnCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrear.Click
        ...
        If afc.DialogResult = Windows.Forms.DialogResult.OK Then
            ...
            Me.isupplierinvoiceid = afc.isupplierinvoiceid
            Me.isupplierid = afc.isupplierid
            Me.ssuppliername = afc.ssuppliername
            Me.ssupplierinvoicedescription = afc.ssupplierinvoicedescription

            If afc.wasCreated = True Then
                Me.wasCreated = True
            End If
    ...
    Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        ...
        Try
            ...
            msSaveFileDialog.FileName = "Facturas Combustible " & fecha
    ...
    Private Function ExportToExcel(ByVal pth As String) As Boolean
        ...
        Try
            ...
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""178.5""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""158.25""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""75.75""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""105.75""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""134.25""/>")


            fs.WriteLine("   <Row ss:AutoFitHeight=""0"">")
            fs.WriteLine("  <Cell ss:MergeAcross=""4"" ss:StyleID=""1""><Data ss:Type=""String"">FACTURAS DE COMBUSTIBLE</Data></Cell>")
            fs.WriteLine("   </Row>")
