Public Class BuscaIngresos
    ...
    Private Sub BuscaIngresos_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Buscar Ingresos con el Ingreso " & iincomeid & " : " & sincomedescription & " seleccionado', 'OK')")

    End Sub


    Private Sub BuscaIngresos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub BuscaIngresos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT ic.iincomeid AS 'ID', " & _
        "STR_TO_DATE(CONCAT(ic.iincomedate, ' ', ic.sincometime), '%Y%c%d %T') AS 'Fecha Ingreso', " & _
        "icty.sincometypedescription AS 'Tipo de Ingreso', ba.sbankname AS 'Banco Origen', " & _
        "ic.soriginaccount AS 'Cuenta Origen', ic.soriginreference AS 'Referencia Origen', " & _
        "ca.scompanyaccountname AS 'Cuenta Destino', " & _
        "ic.sincomedescription AS 'Descripcion Ingreso', FORMAT(ic.dincomeamount, 2) AS 'Cantidad Ingresada', " & _
        "p.speoplefullname AS 'Recibio' " & _
        "FROM incomes ic " & _
        ...
        setDataGridView(dgvIngresos, queryBusqueda, True)

        dgvIngresos.Columns(0).Visible = False

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la Ventana de Buscar Ingresos', 'OK')")
    ...
    Private Sub dgvIngresos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvIngresos.CellClick
        ...
        Try
            ...
            iincomeid = CInt(dgvIngresos.Rows(e.RowIndex).Cells(0).Value)
            sincomedescription = dgvIngresos.Rows(e.RowIndex).Cells(7).Value
            dincomeamount = CDbl(dgvIngresos.Rows(e.RowIndex).Cells(8).Value)
    ...
    Private Sub dgvIngresos_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvIngresos.CellContentClick
    ...
    Private Sub dgvIngresos_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvIngresos.SelectionChanged
        ...
        Try
            ...
            iincomeid = CInt(dgvIngresos.CurrentRow.Cells(0).Value)
            sincomedescription = dgvIngresos.CurrentRow.Cells(7).Value
            dincomeamount = CDbl(dgvIngresos.CurrentRow.Cells(8).Value)
    ...
    Private Sub dgvIngresos_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvIngresos.CellContentDoubleClick
        ...
        If dgvIngresos.SelectedRows.Count = 1 Then
            ...
            ai.iincomeid = iincomeid
            ai.sincomedescription = sincomedescription
            ai.dincomeamount = dincomeamount
    ...
    Private Sub dgvIngresos_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvIngresos.CellDoubleClick
    ...
    Private Sub btnCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrear.Click
        ...
        If ai.DialogResult = Windows.Forms.DialogResult.OK Then
            ...
            Me.iincomeid = ai.iincomeid
            Me.sincomedescription = ai.sincomedescription
            Me.dincomeamount = ai.dincomeamount
    ...
    Private Sub btnExportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        ...
        Try
            ...
            msSaveFileDialog.FileName = "Ingresos " & fecha
            ...
            If msSaveFileDialog.ShowDialog() = DialogResult.OK Then
                ...
                If resultado = True Then
                    MsgBox("Ingresos Exportados Correctamente!" & Chr(13) & "El archivo se abrirá al dar click en OK", MsgBoxStyle.OkOnly, "Exportación Completada")
                    System.Diagnostics.Process.Start(msSaveFileDialog.FileName)
                Else
                    MsgBox("No se ha podido exportar los Ingresos. Intente nuevamente.", MsgBoxStyle.OkOnly, "Error al exportar los Ingresos")
                End If
    ...
    Private Function ExportToExcel(ByVal pth As String) As Boolean
        ...
        Try
            ...
            fs.WriteLine("   <Column ss:Width=""99.75""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""107.25""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""143.25""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""117""/>")
            fs.WriteLine("   <Column ss:Width=""112.5""/>")
            fs.WriteLine("   <Column ss:Width=""157.5""/>")
            fs.WriteLine("   <Column ss:AutoFitWidth=""0"" ss:Width=""69.75""/>")
            fs.WriteLine("   <Column ss:Width=""67.5""/>")

            fs.WriteLine("   <Row ss:AutoFitHeight=""0"">")
            fs.WriteLine("  <Cell ss:MergeAcross=""8"" ss:StyleID=""1""><Data ss:Type=""String"">INGRESOS</Data></Cell>")
            fs.WriteLine("   </Row>")
            ...
            For Each col As DataGridViewColumn In dgvIngresos.Columns
                If col.Visible Then
            ...
            For Each row As DataGridViewRow In dgvIngresos.Rows
                ...
                If dgvIngresos.AllowUserToAddRows = True And row.Index = dgvIngresos.Rows.Count - 1 Then
                    Exit For
                End If
