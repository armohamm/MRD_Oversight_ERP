Public Class BuscaBancos
    ...
    Private Sub setControlsByPermissions(ByVal windowname As String, ByVal username As String)
        ...
        If viewPermission = False Then
            ...
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Acceso denegado a la ventana de Buscar Bancos', 'OK')")
    ...
    Private Sub BuscaBancos_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Buscar Bancos con el banco " & ibankid & " : " & sbankname & " seleccionado', 'OK')")

    End Sub


    Private Sub BuscaBancos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaBancos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT ibankid, sbankname AS 'Banco' " & _
        "FROM banks " & _
        "WHERE sbankname LIKE '%" & querystring & "%' " & _
        "ORDER BY 2 "
        txtBuscar.Enabled = True

        setDataGridView(dgvBancos, queryBusqueda, True)

        dgvBancos.Columns(0).Visible = False

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la Ventana de Buscar Bancos', 'OK')")
    ...
    Private Sub dgvBancos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvBancos.CellClick
        ...
        Try
            ...
            If dgvBancos.CurrentRow Is Nothing Then
                Exit Sub
            End If

            ibankid = CInt(dgvBancos.Rows(e.RowIndex).Cells(0).Value)
            sbankname = dgvBancos.Rows(e.RowIndex).Cells(1).Value
    ...
    Private Sub dgvBancos_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvBancos.SelectionChanged
        ...
        Try
            ...
            ibankid = CInt(dgvBancos.CurrentRow.Cells(0).Value)
            sbankname = dgvBancos.CurrentRow.Cells(1).Value
    ...
    Private Sub dgvBancos_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvBancos.CellContentDoubleClick
        ...
        If dgvBancos.SelectedRows.Count = 1 Then
    ...
    Private Sub dgvBancos_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvBancos.CellDoubleClick
    ...
    Private Sub btnCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrear.Click
        ...
        If ab.DialogResult = Windows.Forms.DialogResult.OK Then
            ...
            Me.ibankid = ab.ibankid
            Me.sbankname = ab.sbankname
