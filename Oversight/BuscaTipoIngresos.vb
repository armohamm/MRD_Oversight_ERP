Public Class BuscaTipoIngresos
    ...
    Private Sub setControlsByPermissions(ByVal windowname As String, ByVal username As String)
        ...
        If viewPermission = False Then
            ...
            executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & fecha & ", '" & hora & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Acceso denegado a la ventana de Buscar Tipos de Ingreso', 'OK')")
    ...
    Private Sub BuscaTipoIngresos_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Cerró la ventana de Buscar Tipos de Ingreso con el Tipo de Ingreso " & iincometypeid & " : " & sincometypedescription & " seleccionado', 'OK')")

    End Sub


    Private Sub BuscaTipoIngresos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaTipoIngresos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT iincometypeid, sincometypedescription AS 'Tipo de Ingreso' " & _
        "FROM incometypes " & _
        "WHERE sincometypedescription LIKE '%" & querystring & "%' " & _
        "ORDER BY 2 "

        txtBuscar.Enabled = True

        setDataGridView(dgvTipoIngresos, queryBusqueda, True)

        dgvTipoIngresos.Columns(0).Visible = False

        executeSQLCommand(0, "INSERT IGNORE INTO logs VALUES (" & getMySQLDate() & ", '" & getAppTime() & "', '" & susername & "', " & susersession & ", '" & suserip & "', '" & susermachinename & "', 'Abrió la Ventana de Buscar Tipos de Ingreso', 'OK')")

        dgvTipoIngresos.Select()
    ...
    Private Sub dgvTipoIngresos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoIngresos.CellClick

        Try

            If dgvTipoIngresos.CurrentRow Is Nothing Then
                Exit Sub
            End If

            iincometypeid = CInt(dgvTipoIngresos.Rows(e.RowIndex).Cells(0).Value)
            sincometypedescription = dgvTipoIngresos.Rows(e.RowIndex).Cells(1).Value
    ...
    Private Sub dgvTipoIngresos_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoIngresos.CellContentClick
    ...
    Private Sub dgvTipoIngresos_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvTipoIngresos.SelectionChanged
        ...
        Try
            ...
            iincometypeid = CInt(dgvTipoIngresos.CurrentRow.Cells(0).Value)
            sincometypedescription = dgvTipoIngresos.CurrentRow.Cells(1).Value
    ...
    Private Sub dgvTipoIngresos_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoIngresos.CellContentDoubleClick
        ...
        If dgvTipoIngresos.SelectedRows.Count = 1 Then
            ...
            Dim ati As New AgregarTipoIngreso

            ati.susername = susername
            ati.bactive = bactive
            ati.bonline = bonline
            ati.suserfullname = suserfullname
            ati.suseremail = suseremail
            ati.susersession = susersession
            ati.susermachinename = susermachinename
            ati.suserip = suserip

            ati.iincometypeid = iincometypeid

            ati.isEdit = True

            If Me.WindowState = FormWindowState.Maximized Then
                ati.WindowState = FormWindowState.Maximized
            End If
    ...
    Private Sub dgvTipoIngresos_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvTipoIngresos.CellDoubleClick
    ...
    Private Sub btnCrear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrear.Click
        ...
        If ati.DialogResult = Windows.Forms.DialogResult.OK Then

            Me.iincometypeid = ati.iincometypeid
            Me.sincometypedescription = ati.sincometypedescription

            If ati.wasCreated = True Then
                Me.wasCreated = True
            End If
