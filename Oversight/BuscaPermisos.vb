Public Class BuscaPermisos
    ...
    Public sselectedpermission As String = ""

    Public swindows() As String
    ...
    Public selectedMany As Boolean = False
    ...
    Private Sub BuscaPermisos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub BuscaPermisos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        queryBusqueda = "" & _
        "SELECT susername AS 'Usuario', swindowname AS 'Ventana', spermission AS 'Permiso' " & _
        "FROM userpermissions " & _
        "WHERE swindowname LIKE '%" & querystring & "%' OR spermission LIKE '%" & querystring & "%' " & _
        "GROUP BY 3, 2 " & _
        "ORDER BY 1, 2, 3 "

        txtBuscar.Enabled = True

        setDataGridView(dgvPermisos, queryBusqueda, True)

        dgvPermisos.Columns(0).Visible = False

        dgvPermisos.Columns(0).Width = 100
        dgvPermisos.Columns(1).Width = 100
        dgvPermisos.Columns(2).Width = 100
    ...
    Private Sub dgvPermisos_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPermisos.CellClick

        Try

            If dgvPermisos.CurrentRow Is Nothing Then
                Exit Sub
            End If

            sselectedusername = dgvPermisos.Rows(e.RowIndex).Cells(0).Value
            sselectedwindowname = dgvPermisos.Rows(e.RowIndex).Cells(1).Value
            sselectedpermission = dgvPermisos.Rows(e.RowIndex).Cells(2).Value
    ...
    Private Sub dgvPermisos_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPermisos.CellContentClick
    ...
    Private Sub dgvPermisos_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvPermisos.SelectionChanged
        ...
        Try
            ...
            sselectedusername = dgvPermisos.CurrentRow.Cells(0).Value
            sselectedwindowname = dgvPermisos.CurrentRow.Cells(1).Value
            sselectedpermission = dgvPermisos.CurrentRow.Cells(2).Value
    ...
    Private Sub dgvPermisos_CellContentDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPermisos.CellContentDoubleClick
        ...
        If dgvPermisos.SelectedRows.Count = 1 Then
            ...
            ap.sselectedcontrolname = sselectedpermission
    ...
    Private Sub dgvPermisos_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvPermisos.CellDoubleClick
    ...
    Private Sub btnAbrirClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAbrir.Click
        ...
        ElseIf dgvPermisos.SelectedRows.Count > 1 Then

            'Codigo para Insertar Muchos Permisos

            selectedMany = True

            ReDim swindows(dgvPermisos.SelectedRows.Count - 1)
            ReDim spermissions(dgvPermisos.SelectedRows.Count - 1)

            For i = 0 To dgvPermisos.SelectedRows.Count - 1

                swindows(i) = dgvPermisos.SelectedRows(i).Cells(1).Value
                spermissions(i) = dgvPermisos.SelectedRows(i).Cells(2).Value
